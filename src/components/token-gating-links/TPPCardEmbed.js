    ...
    <div data-theme={theme}>  {/* 
      ...
      <div className="mx-2 my-4 card border border-base-300 bg-base-100">
        ...
        <div className="card-body">
          ...
          <p className="font-body text-neutral-content text-xs text-left">{link.desc ? link.desc : "A token gated link that is only visitable for the holders of this NFT"}</p> 
