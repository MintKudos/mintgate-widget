    ...
    <div data-theme="light">  {/* 
      ...
      <div className="mx-2 my-4 card border border-base-300 bg-base-100">
        ...
        <div className="card-body">
          <h2 className="card-title text-md text-left font-heading font-semibold">{link.title ? link.title : "Gated Link"}</h2> 
          <p className="font-body text-xs text-left">{link.desc ? link.desc : "A token gated link that is only visitable for the holders of this NFT"}</p> 
